...
MusicPlayer::MusicPlayer(): music(), filenames(), volume(100.f)
{
	...
	filenames[MusicID::Texas] = "Media/Music/Texas.wav";
	filenames[MusicID::Sweeden] = "Media/Music/Sweeden.wav";
	filenames[MusicID::UK] = "Media/Music/UK.wav";
	filenames[MusicID::Japan] = "Media/Music/MysticalForestTheme.wav";
}
