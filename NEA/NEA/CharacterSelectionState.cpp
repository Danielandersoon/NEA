...
CharacterSelectionState::CharacterSelectionState(StateStack& stack, Context context):State(stack, context), mOptions(), mOptionIndex(0), selectionCount(1)
{
	...
	menuTitle.setString("Genre Selection");
	...
	sf::Text C1Option;
	c1PortraitTexture.loadFromFile("Media/Textures/Fight/genre1Avatar.png");
	...
	sf::Text C2Option;
	c2PortraitTexture.loadFromFile("Media/Textures/Fight/genre2Avatar.png");
	...
	sf::Text C3Option;
	c3PortraitTexture.loadFromFile("Media/Textures/Fight/genre3Avatar.png");
	...
	hudLeftFilePaths.insert(std::make_pair(OptionNames::C1, "Media/Textures/Fight/genre1HUDLeft.png"));
	hudLeftFilePaths.insert(std::make_pair(OptionNames::C2, "Media/Textures/Fight/genre2HUDLeft.png"));
	hudLeftFilePaths.insert(std::make_pair(OptionNames::C3, "Media/Textures/Fight/genre3HUDLeft.png"));
	hudRightFilePaths.insert(std::make_pair(OptionNames::C1, "Media/Textures/Fight/genre1HUDRight.png"));
	hudRightFilePaths.insert(std::make_pair(OptionNames::C2, "Media/Textures/Fight/genre2HUDRight.png"));
	hudRightFilePaths.insert(std::make_pair(OptionNames::C3, "Media/Textures/Fight/genre3HUDRight.png"));
}
