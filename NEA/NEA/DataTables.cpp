...
std::map<Actor::Type, ActorData> initializeActorData()
{
	...
	JsonFrameParser hero1 = JsonFrameParser("Media/Textures/Fight/genre1.json");
	...
	JsonFrameParser hero2 = JsonFrameParser("Media/Textures/Fight/genre2.json");
	...
	JsonFrameParser hero3 = JsonFrameParser("Media/Textures/Fight/genre3.json");
