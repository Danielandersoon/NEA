...
OptionsState::OptionsState(StateStack& stack, Context context):State(stack, context), mOptionIndex(0), mOptions()
{
	...
	option1.setString("Anti-Aliesing");
