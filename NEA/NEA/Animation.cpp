...
Animation::Animation() : sprite(), frameSize(), numFrames(0), currentFrame(0)
, duration(sf::Time::Zero), elapsedTime(sf::Time::Zero), repeat(false)
{}

Animation::Animation(const sf::Texture& texture) : sprite(texture)
	, frameSize()
	, numFrames(0)
	, currentFrame(0)
